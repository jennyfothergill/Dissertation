...
\texttt{PlanckTon} was started by my labmates Mike Henry, Evan Miller, and Matty Jones\cite{Jankowski2019, planckton}, and I have assumed responsibility for its development including:
...
A \texttt{PlanckTon-flow} workspace of 40 simulations defined by their temperature and solvent parameter ($\epsilon_{s}$) was initialized. Each system comprised of 100 united-atom (UA) P3HT 16-mers parameterized with GAFF. %(The compound can be found in planckton as "P3HT-16-gaff" and the forcefield is "gaff-custom".) 
