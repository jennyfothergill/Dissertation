...
\Cref{chap:p3ht_validation} details validation of an updated workflow to explore the state-space dependence of the ordering of poly-3-hexylthiophene (P3HT) polymer. 
...
\Cref{chap:reproducibility} summarizes my effort in a multi-university collaborative study to use MoSDeF tools reproducibly which is in preparation. 
